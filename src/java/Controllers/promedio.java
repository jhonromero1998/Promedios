...
public class promedio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        double examenparcial= Double.parseDouble(request.getParameter("examenparcial"));
        double examenfinal= Double.parseDouble(request.getParameter("examenfinal"));
        double proyecto= Double.parseDouble(request.getParameter("promedio"));
        
        double promedio = ((examenparcial+examenfinal+proyecto)/3);
